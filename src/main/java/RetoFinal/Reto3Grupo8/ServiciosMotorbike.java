...
public class ServiciosMotorbike {
    ...
    public Optional<Motorbike> getMotorbike(int machineId) {
        return metodosCrud.getMotorbike(machineId);
    }
    ...
    public boolean deleteMotorbike(int machineId) {
        Boolean aBoolean = getMotorbike(machineId).map(motorbike -> {
